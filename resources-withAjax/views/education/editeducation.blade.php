                ...
                <div class="card-body card-block">
                  ...
                  @endif
                    <div class="form-group">
                        ...
                        <input type="text" id="title" placeholder="Enter your degree name" class="form-control" name="name" value="{{!old('name')?$data->name : old('name')}}">
                    </div>
                    <div class="form-group">
                        <label for="description" class=" form-control-label">Degree Description</label>
                        <input type="text" id="description" placeholder="Enter your last name" class="form-control" name="description" value="{{!old('description')?$data->description : old('description')}}">
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-8">
                            <div class="form-group">
                                ...
                                <input type="text" id="passing_year" placeholder="Enter Passing Year" class="form-control" name="passing_year" value="{{!old('passing_year')?$data->passing_year : old('passing_year')}}">
                            </div>
                        </div>
                        <div class="col-8">
                            <div class="form-group">
                                <label for="marks" class=" form-control-label">Marks Percentage</label>
                                <input type="text" id="postal-code" placeholder="Enter Marks in Percentage" class="form-control" name="marks" value="{{!old('marks')?$data->marks_percentage : old('marks')}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="institute" class=" form-control-label">Institute Name</label>
                        <input type="text" id="institute" placeholder="Name of the Institute" class="form-control" name="institute" value="{{!old('institute')?$data->institute : old('institute')}}">
                    </div>
                    <div class="form-group">
